...
// ignore_for_file: prefer_const_constructors, file_names, recursive_getters

import 'package:flutter/material.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:hummy/services/auth.dart';
import 'package:hummy/services/database.dart';
...
class _AvatarsState extends State<Avatars> {
 ...
 Future<void> AddAvatar (String avatar) async{
   
  final prefs = await SharedPreferences.getInstance();

  final token = prefs.getString('userID');
  final firestore = FirebaseFirestore.instance;
  firestore.collection('users').doc(token).update({'avatar': avatar});
}
  ...
  String imge="assets/img/img_19.png";
                ...
                child: Row(
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      backgroundColor: Color.fromARGB(177, 167, 220, 245),
                      backgroundImage: img,
                    ),
                  ],),),
              ...
              Center(child: Row(
                ...
                children: [
                  Title(color: Colors.blue, child: const Text(
                    ...
                    "choisir un avatar",style: TextStyle(fontFamily: 'FredokaOne',fontSize: 35,color:  Color(
                        0xff010158)),),)
                ],
              )
              ),
                    ...
                    Column(
                      children: [
                        ...
                        ElevatedButton(onPressed: _isDisable? null : () {
                          AddAvatar(imge);
                          // DatabaseService().updateUserAvatar(user.uid, img.toString() );
                        Navigator.pushNamed(
                                        context, '/bienvenue');
                        },
