// ignore_for_file: prefer_const_constructors, non_constant_identifier_names, must_be_immutable, prefer_adjacent_string_concatenation, unused_local_variable, duplicate_ignore
 ...
 late bool remove;
  ...
  items = [
      ...
      FruitBox('assets/img/FoodetS/milk.png', Colors.transparent,true,false),
       FruitBox('assets/img/DDimg/candies.png', Colors.transparent,false,false),
        FruitBox('assets/img/FoodetS/croissant.png', Colors.transparent,true,false),
     ...
     //FruitBox('assets/img/FoodetS/butter.png', Colors.transparent,true,true), /*==''? null : FruitBox(activeEmoji, Colors.cyanAccent)*/
        ...
        builder: (BuildContext context) => Container( decoration: const BoxDecoration(
          ...
          child: AlertDialog( shape:  const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(32.2))),
               ...
               content: const Text("Bravo 🎈, tu as bien composé ton assiette du petit déjeuner Sache bien qu’au petit déjeuner , tu dois prendre un produit laitier comme lait et un féculent : tartine ou croissant . Et surtout tu évites les sucreries comme le chocolat , les gâteaux et surtout le matin quand ton ventre est vide.",style: TextStyle(color:  Color(
                          0xff010158),fontSize: 18),textAlign: TextAlign.center),
            actions: [
              Row( mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
