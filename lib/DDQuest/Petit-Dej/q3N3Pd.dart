...
class Prodlait extends StatefulWidget {
  late Widget? Next;
   late bool? repeat;
   late bool? faite;
   Prodlait({
  ...
  @override
  State<Prodlait> createState() => _ProdlaitState();
}

class _ProdlaitState extends State<Prodlait> {
 ...
 late bool remove;
  ...
  items = [
       ...
       FruitBox('assets/img/DDimg/honey.png', Colors.transparent,false,false),
        FruitBox('assets/img/DDimg/yugurt.png', Colors.transparent,true,false),
        ...
        FruitBox('assets/img/DDimg/kiwi.png', Colors.transparent,false,false),
              ...
              Column(
                children: [
                 ...
                 ElevatedButton.icon(onPressed: (){}, icon:const Icon(Icons.volume_up_rounded,color : Color(
                      0xff010158) ,size: 40,) , label: const Text('Range tous les produits laitiers dans le panier',style: TextStyle(fontSize: 21,color: Color.fromARGB(255, 124, 38, 12),),textAlign : TextAlign.center),
 ...
 borderRadius: BorderRadius.circular(45)
                      ...
                      // color : const Color(0xFFFFC38B),
                      child :
                        const Image(image : AssetImage('assets/img/DDimg/Prodlait.png'),)
     //FruitBox('assets/img/FoodetS/butter.png', Colors.transparent,true,true), /*==''? null : FruitBox(activeEmoji, Colors.cyanAccent)*/
             ...
             shape: CircleBorder(),
             backgroundColor: Colors.transparent,
            title: Text('Bravo 👏🏻',style: TextStyle(fontSize: 40,color: Colors.green),textAlign: TextAlign.center,),
             content: Text('Bien choisi !🤗🎉🎊'+'Salim',style: TextStyle(fontSize: 40,color: Colors.green),textAlign: TextAlign.center)
           )
           );
                });
           ...
           setState(() {
            ...
            showDialog(context: context, builder: (context)=>const AlertDialog(
                                //shape: CircleBorder(),
                              backgroundColor: Colors.transparent,
                                title: Text('Non❌',style: TextStyle(fontSize: 40,color: Colors.red),textAlign: TextAlign.center,),
                               content: Text("ce n'est pas un produit laitier",style: TextStyle(fontSize: 39,color: Colors.red),textAlign: TextAlign.center)
          ));
          });}
        
              
        
               if ((tentative==3)&&(score==40))
              {
                showDialog(
        ...
        builder: (BuildContext context) => Container( decoration: const BoxDecoration(
          ...
          child: AlertDialog( shape:  const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(32.2))),
               ...
               content: const Text("Les produits laitiers sont des aliments fabriqués avec la matière première : lait , et notre famille regroupe plusieurs produits dont : le fromage et toutes ses types , le yaourt, le comembert ",style: TextStyle(color:  Color(
                          0xff010158),fontSize: 18),textAlign: TextAlign.center),
            actions: [
              Row( mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
        ...
        Navigator.of(context).pop();}, child: const Text('Allons-ez a savoir',style: TextStyle(color:  Color(
                            0xff010158),fontSize: 18),textAlign: TextAlign.center),
        ...
        builder: (BuildContext context) => Container( decoration: const BoxDecoration(
          ...
          child: AlertDialog( shape:  const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(32.2))),
               ...
               content: const Text("Voici Quelque exemples des produit laitiers: \n 🧈🥛🍮🧀",style: TextStyle(color:  Color(
...
//             mainAxisAlignment:  MainAxisAlignment.spaceAround,
//             children: [
//               Title(color: Colors.deepOrangeAccent, child: const Text(' \n\n\nrange tous les produits laitiers ',style: const TextStyle(fontSize: 18,color: const Color.fromARGB(255, 124, 38, 12)),)),
...
//                   child :
//                     const Image(image : AssetImage('assets/img/DDimg/Prodlait.png'),)//vitamine C
//      //FruitBox('assets/img/FoodetS/butter.png', Colors.transparent,true,true), /*==''? null : FruitBox(activeEmoji, Colors.cyanAccent)*/
//                 );
//               },
//               //onwill ccpt to accept the necessary things
...
class _ProdlaitState extends State<Prodlait> {
 ...
 borderRadius: BorderRadius.circular(45)
     ...
     //FruitBox('assets/img/FoodetS/butter.png', Colors.transparent,true,true), /*==''? null : FruitBox(activeEmoji, Colors.cyanAccent)*/
         ...
         title: 'Non ❌',
          text: "'ce n'est pas un produit laitier'",
...
//                                animationDuration: const Duration(milliseconds: 100),
        ...
        builder: (BuildContext context) => AlertDialog(
          ...
          title: const Text('🌟',style: TextStyle(color:  Color.fromARGB(242, 1, 1, 88),fontSize: 28),textAlign: TextAlign.center),
          content: const Text('Yay 🎊🎉🎉 Bravoo ✨🎉',style: TextStyle(color:  Color(
                        0xff010158),fontSize: 18),textAlign: TextAlign.center),
          actions: [
            Row( mainAxisAlignment: MainAxisAlignment.spaceEvenly,
