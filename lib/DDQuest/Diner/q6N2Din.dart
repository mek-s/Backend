// ignore_for_file: prefer_const_constructors, non_constant_identifier_names, must_be_immutable, prefer_adjacent_string_concatenation, duplicate_ignore, file_names, unused_local_variable
...
class _Din2State extends State<Din2> {
 ...
 late bool remove;
  ...
  items = [
      ...
      FruitBox('assets/img/DDimg/watermelon.png', Colors.transparent,true,false),
       FruitBox('assets/img/DDimg/donut.png', Colors.transparent,false,false),
        FruitBox('assets/img/DDimg/boiled-egg.png', Colors.transparent,true,false),
         FruitBox('assets/img/DDimg/dessert.png', Colors.transparent,false,false),
         FruitBox('assets/img/DDimg/rice-bowl.png', Colors.transparent,true,false),
         FruitBox('assets/img/DDimg/croissant2.png', Colors.transparent,false,false),
        ...
        builder: (BuildContext context) => Container( decoration: const BoxDecoration(
          ...
          child: AlertDialog(
             shape:  const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(32.2))),
               ...
               content: const Text("En dîner , tu dois éviter de manger tout ce qui est sucré comme: les gâteaux ,les glaces , car consommer trop de sucreries nuit à ta santé , et on le remplace par un fruit comme : la pastèque,la fraise … , aussi il faut apprendre que tu ne dois pas ajouter du sel à ton plat ",style: TextStyle(color:  Color(
                          0xff010158),fontSize: 18),textAlign: TextAlign.center),
            actions: [
              Row( mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
        ...
        builder: (BuildContext context) => Container( decoration: const BoxDecoration(
          ...
          child: AlertDialog(
             shape:  const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(32.2))),
               ...
               content: const Text("Indice :\n Voici quelque aliments qu'on mange en diner\n🍲🥬🥩🍗🍵🧆🥗 🍉🍌🍎",style: TextStyle(color:  Color(
