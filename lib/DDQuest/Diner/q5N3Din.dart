// ignore_for_file: prefer_const_constructors, non_constant_identifier_names, must_be_immutable, prefer_adjacent_string_concatenation, camel_case_types, file_names, unused_local_variable
...
class proteinN3Din extends StatefulWidget {
late Widget? Next;
   late bool? repeat;
   late bool? faite;
   proteinN3Din({
  ...
  @override
  State<proteinN3Din> createState() => _proteinN3DinState();
}

class _proteinN3DinState extends State<proteinN3Din> {
 ...
 late bool remove;
  ...
  items = [
       ...
       FruitBox('assets/img/DDimg/boiled-egg.png', Colors.transparent,true,false),
       FruitBox('assets/img/DDimg/bread.png', Colors.transparent,false,false),
        FruitBox('assets/img/DDimg/bifteck.png', Colors.transparent,true,false),
         FruitBox('assets/img/FoodetS/carrot.png', Colors.transparent,false,false),
          FruitBox('assets/img/DDimg/pepper.png', Colors.transparent,false,false),
         FruitBox('assets/img/DDimg/fish.png', Colors.transparent,true,false),
           FruitBox('assets/img/DDimg/shrimp.png', Colors.transparent,true,false),
             FruitBox('assets/img/DDimg/lemon.png', Colors.transparent,false,false),
               FruitBox('assets/img/DDimg/ham-leg.png', Colors.transparent,true,false),
                ...
                child: Column(
                  children: [
                   ...
                   ElevatedButton.icon(onPressed: (){}, icon:const Icon(Icons.volume_up_rounded,color : Color(
                        0xff010158) ,size: 40,) , label: const Text("je gagne du proteines",style: TextStyle(fontSize: 21,color: Color.fromARGB(255, 124, 38, 12),),textAlign : TextAlign.center),
 ...
 borderRadius: BorderRadius.circular(45)
                        ...
                        // color : const Color(0xFFFFC38B),
                        child :
                          const Image(image : AssetImage('assets/img/DDimg/proteinBasket.png'),)
     //FruitBox('assets/img/FoodetS/butter.png', Colors.transparent,true,true), /*==''? null : FruitBox(activeEmoji, Colors.cyanAccent)*/
           ...
           setState(() {
            ...
            showDialog(context: context, builder: (context)=>const AlertDialog(
                                      ...
                                      backgroundColor: Colors.transparent,
                                       ...
                                       content: Text("ça ne me donne pas du proteines",style: TextStyle(fontSize: 39,color: Colors.red),textAlign: TextAlign.center)
          ));
          });}
        ...
        builder: (BuildContext context) => Container( decoration: const BoxDecoration(
          ...
          child: AlertDialog( shape:  const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(32.2))),
               ...
               content: const Text("Nous sommes les protéines , essentielles pour assurer ta croissance et ton développement car toutes les parties de ton corps ont besoin de nous vu notre important rôle dans le renouvellement de tes cheveux, ongles .. Il est recommandé de nous consommer au moins 2 fois par jour et pour cela  tu peux nous trouver dans plusieurs aliments dont : Les viandes, les poissons même les oeufs , et les produits laitiers en général : lait, fromage … .",style: TextStyle(color:  Color(
                          0xff010158),fontSize: 18),textAlign: TextAlign.center),
            actions: [
              Row( mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
        ...
        builder: (BuildContext context) => Container( decoration: const BoxDecoration(
          ...
          child: AlertDialog(
             shape:  const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(32.2))),
               ...
               content: const Text("Indice :\n Voici quelque aliments donnenat du protien\n🐟🥩🍗 ",style: TextStyle(color:  Color(
...
class _proteinN3DinState extends State<proteinN3Din> {
 ...
 borderRadius: BorderRadius.circular(45)
     ...
     //FruitBox('assets/img/FoodetS/butter.png', Colors.transparent,true,true), /*==''? null : FruitBox(activeEmoji, Colors.cyanAccent)*/
          ...
          text: 'ça ne me donne pas du proteines',
        );
          //   showDialog(context: context, builder: (context)=>const AlertDialog(
          //                               //shape: CircleBorder(),
          //                             backgroundColor: Colors.transparent,
