...
// ignore_for_file: prefer_const_constructors, non_constant_identifier_names, must_be_immutable, file_names, unused_local_variable
...
class _MEGState extends State<MEG> {
 ...
 late bool remove;
  ...
  items = [
       ...
       FruitBox('assets/img/DDimg/sweet-potato.png', Colors.transparent,true,false),
        FruitBox('assets/img/DDimg/almond.png', Colors.transparent,true,false),
         ...
         FruitBox('assets/img/DDimg/brown-rice.png', Colors.transparent,true,false),
        FruitBox('assets/img/DDimg/banane.png', Colors.transparent,true,false),
          FruitBox('assets/img/DDimg/waterm.png', Colors.transparent,false,false),
         FruitBox('assets/img/DDimg/spinach.png', Colors.transparent,true,false),
              ...
              Column(
                children: [
                 ...
                 ElevatedButton.icon(onPressed: (){}, icon:const Icon(Icons.volume_up_rounded,color : Color(
                      0xff010158) ,size: 40,) , label: const Text('je gagne du magnésium en mangeant',style: TextStyle(fontSize: 21,color: Color.fromARGB(255, 124, 38, 12),),textAlign : TextAlign.center),
 ...
 borderRadius: BorderRadius.circular(45)
                      ...
                      // color : const Color(0xFFFFC38B),
                      child :
                        const Image(image : AssetImage('assets/img/DDimg/MGN.png'),)
     //FruitBox('assets/img/FoodetS/butter.png', Colors.transparent,true,true), /*==''? null : FruitBox(activeEmoji, Colors.cyanAccent)*/
           ...
           setState(() {
            ...
            showDialog(context: context, builder: (context)=>const AlertDialog(
                              ...
                              backgroundColor: Colors.transparent,
                               ...
                               content: Text('ça me donne pas du  magnésium  ',style: TextStyle(fontSize: 39,color: Colors.red),textAlign: TextAlign.center)
          ));
          });}
        ...
        builder: (BuildContext context) => Container( decoration: const BoxDecoration(
          ...
          child: AlertDialog( shape:  const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(32.2))),
               ...
               content: const Text("Je suis un minéral essentiel pour le bon fonctionnement de ton corps.J’aide à transmettre l’énergie dans ton organisme.Tu peux me trouver dans plusieurs aliments dont les fruits et les légumes comme: La banane, la pomme de terre … ainsi les céréales , le chocolat,les amandes ….Et si ton corps me manque tu risquera d'être fatigué et en mauvaise humeur",style: TextStyle(color:  Color(
                          0xff010158),fontSize: 18),textAlign: TextAlign.center),
            actions: [
              Row( mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
        ...
        builder: (BuildContext context) => Container( decoration: const BoxDecoration(
          ...
          child: AlertDialog(
             shape:  const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(32.2))),
               ...
               content: const Text("Indice :\n Voici quelque aliments donnenat du magnésium\n🍌🥛🥝 ",style: TextStyle(color:  Color(
...
//             mainAxisAlignment:  MainAxisAlignment.spaceAround,
//             children: [
//               Title(color: Colors.deepOrangeAccent, child: const Text(' \n\n\nje gagne du magnésium en mangeant',style: const TextStyle(fontSize: 18,color: const Color.fromARGB(255, 124, 38, 12)),)),
...
//                   child :
//                     const Image(image : AssetImage('assets/img/DDimg/MGN.png'),)//vitamine C
//      //FruitBox('assets/img/FoodetS/butter.png', Colors.transparent,true,true), /*==''? null : FruitBox(activeEmoji, Colors.cyanAccent)*/
//                 );
//               },
//               //onwill ccpt to accept the necessary things
...
//                                 backgroundColor: Colors.transparent,
//                                   title: Text('Non❌',style: TextStyle(fontSize: 60,color: Colors.red),textAlign: TextAlign.center,),
//                                  content: Text('ça me donne pas du magnesium',style: TextStyle(fontSize: 39,color: Colors.red),textAlign: TextAlign.center)
//           ));
//           });}
...
class _MEGState extends State<MEG> {
 ...
 borderRadius: BorderRadius.circular(45)
     ...
     //FruitBox('assets/img/FoodetS/butter.png', Colors.transparent,true,true), /*==''? null : FruitBox(activeEmoji, Colors.cyanAccent)*/
          ...
          text: 'ça ne me donne pas du magnésium',
        );
          //   showDialog(context: context, builder: (context)=>const AlertDialog(
          //                       //shape: CircleBorder(),
          //                     backgroundColor: Colors.transparent,
