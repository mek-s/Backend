// ignore_for_file: unused_import, must_be_immutable, non_constant_identifier_names, file_names, unused_local_variable
...
class _Dej2State extends State<Dej2> {
 ...
 late bool remove;
  ...
  items = [
      ...
      FruitBox('assets/img/FoodetS/grapes.png', Colors.transparent,true,false),
       FruitBox('assets/img/DDimg/pancakes.png', Colors.transparent,false,false),
        FruitBox('assets/img/DDimg/ham-leg.png', Colors.transparent,true,false),
         FruitBox('assets/img/DDimg/cereals.png', Colors.transparent,false,false),
          FruitBox('assets/img/DDimg/salade2.png', Colors.transparent,true,false),
         FruitBox('assets/img/FoodetS/honey.png', Colors.transparent,false,false),
              ...
              Column(
                children: [
                 ...
                 ElevatedButton.icon(onPressed: (){}, icon:const Icon(Icons.volume_up_rounded,color : Color(
                      0xff010158) ,size: 40,) , label: const Text(' Pour le déjeuner, je mange ...',style: TextStyle(fontSize: 21,color: Color.fromARGB(255, 124, 38, 12),),textAlign : TextAlign.center),
